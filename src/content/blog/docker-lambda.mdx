...
![Create Lambda Docker function](/src/assets/images/lambda-docker-create-lambda.png "Create Lambda Docker function")
...
```
![Lambda Docker test run](/src/assets/images/lambda-docker-test-run.png "Lambda Docker test run")

Congratulation, we have the final result !
![Lambda Docker result](/src/assets/images/lambda-docker-result.png "Lambda Docker result")
